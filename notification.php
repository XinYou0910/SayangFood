...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="dropdown-container" id="dropdownMenu">
      ...
      <button class="submenu-item" data-page="weekly_meal_plan.html" onclick="window.location.href='weekly_meal_plan.html'">Weekly Meal</button>
      <button class="submenu-item" data-page="donation_list.php" onclick="window.location.href='donation_list.php'">Donations</button>
    </div>

    <button class="menu-item" onclick="location.href='inventory_list.php'">
